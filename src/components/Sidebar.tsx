 ...
 * flex row that wraps to a column, sidebar second), so this never takes
 * horizontal space away from the drawing regardless of the `<details>`
 * open/closed state. Open by default — the hints are worth seeing without a
 * click — with `<details>` giving the student a one-click way to tuck them
 * away once they don't need the reminder.
 */
